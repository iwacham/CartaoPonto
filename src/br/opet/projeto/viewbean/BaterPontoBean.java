...
public class BaterPontoBean
{
    ...
    public List<BaterPonto> listarHorasContestadas()
    {
        ...
        if (bpc.listarHorasContestadas().isEmpty() || bpc.listarHorasContestadas() == null)
        {
            try
            {
                FacesContext.getCurrentInstance().getExternalContext()
    ...
    public List<BaterPonto> listarPontoFuncionario()
    {
        ...
        if (bpc.procurarPorChave(bp.getNmUsuario()).isEmpty() || bpc.procurarPorChave(bp.getNmUsuario()) == null)
        {
            try
            {
                FacesContext.getCurrentInstance().getExternalContext()
